<div class="row margin-t-40 margin-b-40">
    ...
    <script>
        var config3 = {
            ...
            data: {
                datasets: [{
                    data: [
                        @isset($chart['dates'][app\Models\Statistics::TYPES['normal']])
                        {{$chart['dates'][app\Models\Statistics::TYPES['normal']]}},
                        @endisset
                        @isset($chart['dates'][app\Models\Statistics::TYPES['latey_early']])
                        {{$chart['dates'][app\Models\Statistics::TYPES['latey_early']]}},
                        @endisset
                        @isset($chart['dates'][app\Models\Statistics::TYPES['ot']])
                        {{$chart['dates'][app\Models\Statistics::TYPES['ot']]}},
                        @endisset
                        @isset($chart['dates'][app\Models\Statistics::TYPES['lately_ot']])
                        {{$chart['dates'][app\Models\Statistics::TYPES['lately_ot']]}},
                        @endisset
                        @isset($chart['dates'][app\Models\Statistics::TYPES['leave']])
                        {{$chart['dates'][app\Models\Statistics::TYPES['leave']]}},
                        @endisset
                    ],
                    backgroundColor: [
                        @isset($chart['dates'][app\Models\Statistics::TYPES['normal']])
...
<script>
    ...
    window.onload = function() {
        ...
        if (typeof config3 !== 'undefined') {
            window.myDoughnut = new Chart(ctx2, config3);
        } else {
            //window.myDoughnut = new Chart(ctx2, config_default);
        }
    };
</script>
