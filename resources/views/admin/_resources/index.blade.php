                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="#" class="btn btn-sm btn-danger" id="btnDeleteMutiple">
                                <i class="fa fa-close"></i> <span>Xóa các mục đã chọn</span>
                            </a>
                        ...
                        <div class="col-sm-6 text-right">
                            <span class="text-green padding-l-5">Tổng số: {{ $total }} mục.</span>&nbsp;
                        </div>
                    </div>
                </div>
                @include($resourceAlias.'.table')
            @else
                <p class="margin-l-5 lead text-green">Không có dữ liệu được tìm thấy.</p>
            @endif
        </div>
        <!-- /.box-body -->
        @if (count($records) > 0)
