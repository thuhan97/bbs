             ...
             <div class="modal fade" id="modal-form-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                 ...
                 <div class="modal-dialog modal-center" role="document">
                     <div class="modal-content" id="bg-img" style="background-image: url({{ asset('img/font/xin_nghi.png') }})">
                         ...
                         <form action="{{ route('edit_day_off_detail',['id'=>$dayOff->id]) }}" method="post" id="edit-day-off">
                             @csrf
                             <div class="modal-body mx-3 mt-0 pb-0">
                                 <div class="mb-3">
                                     <label class="ml-3 text-w-400" for="exampleFormControlTextarea5">Tên nhân viên</label>
                                     <input type="text" readonly="readonly" class="form-control select-item {{ $errors->has('start_at') ? ' has-error' : '' }}" value="{{ $dayOff->user->name }}">
                                 </div>
                                 <div class="mb-3">
                                     <!-- Default input -->
                                     ...
                                     <div class="row">
                                         <div class="form-group col-6 m-0">
                                             ...
                                             <input type="text"
                                                    ...
                                                    value="{{ old('start_at',$dayOff->start_at) }}" readonly>
                                         </div>
                                         <!-- Default input -->
                                         <div class="form-group col-6 m-0">
                                 ...
                                 <div>
                                     ...
                                     {{ Form::select('approver_id', $manager, $dayOff->approver_id, ['class' => 'form-control my-1 mr-1 browser-default custom-select md-form select-item']) }}
                             ...
                             <div class="pt-3 pb-4 d-flex justify-content-center border-top-0 rounded mb-0">
                                 <p class="btn btn-primary btn-send" id="btn-edit-day-off">SỬA ĐƠN</p>
                             </div>
                         </form>
                     </div>
                 </div>
