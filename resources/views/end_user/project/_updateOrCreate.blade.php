...
@push('footer-scripts')
    <script>
        $(function () {
            ...
            html += '</td>'
            html += '<td class="text-center"><input name="contract[]" class="form-control" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, \'\'); this.value = this.value.replace(/(\\..*)\\./g, \'$1\');" ></td>'
            html += '<td class="text-center"><input name="reality[]" class="form-control" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, \'\'); this.value = this.value.replace(/(\\..*)\\./g, \'$1\');" ></td>'
            html += '<td class="text-center"><input readonly="readonly" name="time_start[]" class="form-control time-start" type="text"></td>'
            html += '<td class="text-center"><input readonly="readonly" name="time_end[]" class="form-control time-end" type="text"></td>'
            html += '<td>'
