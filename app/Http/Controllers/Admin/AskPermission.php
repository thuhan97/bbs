 ...
 */
class AskPermission extends AdminBaseController
{
    /**
     * @var  string
     */
    protected $resourceAlias = 'admin.ask_permission';

    /**
     * @var  string
     */
    protected $resourceRoutesAlias = 'admin::ask_permission';
    ...
    protected $resourceSearchExtend = 'admin.ask_permission._search_extend';
