    ...
    var e, i = function () {
        ...
        return _createClass(e, [{
            ...
            key: "appendSearchInputOption", value: function () {
                ...
                this.$searchInput = t('<span class="search-wrap ml-2"><div class="md-form mt-0"><input type="text" class="search form-control w-100 d-block" placeholder="'.concat(e, '"></div></span>')), this.$materialOptionsList.append(this.$searchInput), this.$searchInput.on("click", function (e) {
                    e.stopPropagation()
                })
            }
        }, {
