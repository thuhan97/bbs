<div class="input-group input-group-sm margin-r-5 pull-left" style="width: 600px;">
    <input type="text" name="search" class="mr-1 w-22 form-control" value="{{ $search }}"
           placeholder="Search...">
    {{ Form::select('jobtitle_id', ['' => 'Chức vụ'] + JOB_TITLES, request('jobtitle_id'), ['class'=>'mr-1 w-35 form-control']) }}
    {{ Form::select('contract_type', ['' => 'Loại hợp đồng'] + CONTRACT_TYPES_NAME, request('contract_type'), ['class'=>'mr-1 w-35 form-control']) }}
