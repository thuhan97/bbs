...
trait ResourceHelper
{
    ...
    {
        if (property_exists($this, 'resourceRepository') && !empty($this->resourceRepository)) {
            return $this->resourceRepository;
        } else {
            throw new \InvalidArgumentException('The property "resourceRepository" is not defined');
        }
    }
